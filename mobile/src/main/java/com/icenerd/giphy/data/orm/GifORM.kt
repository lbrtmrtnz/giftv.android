...
class GifORM(db: SQLiteDatabase) : ORM<GifModel>(db, TABLE) {
    companion object {
        const val TABLE = "giphy_gif"

        const val COL_ID = "id"
        const val COL_RATING = "rating"

        const val COL_URL_FIXED_HEIGHT = "fixed_height"
        const val COL_URL_FIXED_HEIGHT_STILL = "fixed_height_still"
        const val COL_URL_FIXED_HEIGHT_DOWNSAMPLED = "fixed_height_downsampled"
        const val COL_URL_FIXED_WIDTH = "fixed_width"
        const val COL_URL_FIXED_WIDTH_STILL = "fixed_width_still"
        const val COL_URL_FIXED_WIDTH_DOWNSAMPLED = "fixed_width_downsampled"
        const val COL_URL_FIXED_HEIGHT_SMALL = "fixed_height_small"
        const val COL_URL_FIXED_HEIGHT_SMALL_STILL = "fixed_height_small_still"
        const val COL_URL_FIXED_WIDTH_SMALL = "fixed_width_small"
        const val COL_URL_FIXED_WIDTH_SMALL_STILL = "fixed_width_small_still"
        const val COL_URL_DOWNSIZED = "downsized"
        const val COL_URL_DOWNSIZED_STILL = "downsized_still"
        const val COL_URL_DOWNSIZED_LARGE = "downsized_large"
        const val COL_URL_ORIGINAL = "original"
        const val COL_URL_ORIGINAL_STILL = "original_still"
        const val COL_SIZE = "size"

        const val RATING_YOUTH = "y"
        const val RATING_GENERAL = "g"
        const val RATING_PARENTAL_GUIDANCE = "pg"
        const val RATING_PARENTAL_GUIDANCE_13 = "pg-13"
        const val RATING_RESTRICTED = "r"
    }
